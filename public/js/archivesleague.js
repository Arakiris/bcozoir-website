...
window.createLeagueArchives = function (lenghtlast, previousYear, url, url_image, url_storage) {
    ...
    function getDataLeague(id, token, parent, url) {
        renderLoader(parent);
        getDataAjax(url, id, token).then(function (league) {
    ...
    var renderLeague = function renderLeague(league, parent) {
        var dateString = league[0].start_season.substring(0, 10).split('-');
    ...
    var renderLineLeague = function renderLineLeague(league, parent) {
        var dateString = league.start_season.substring(0, 10).split('-');
        ...
        if (typeof league.result !== "undefined") {
            ...
            markup += '\n                <div class="event__single-image event__single-image--disable">\n                    <div class="event__cell--disable">\n                        <img class="event__single-logo" src="' + url_image + '/tournament/Lexer.jpg" alt="Lien lexer du r\xE9sultat">\n                    </div>\n                </div>\n            ';
        }
