...
window.createRankingArchives = function (lenghtlast, previousYear, url, url_image, url_storage) {
    ...
    var renderLineRanking = function renderLineRanking(podium, parent) {
        ...
        // Render first column
        if (typeof podium.tournament.rules_url != "undefined" && podium.tournament.rules_url != null && podium.tournament.is_rules_pdf == 0 || typeof podium.tournament.rules_pdf != "undefined" && podium.tournament.rules_pdf != null && podium.tournament.is_rules_pdf == 1) {
