...
window.createTournamentArchives = function (lenghtlast, previousYear, url, url_home, url_image, url_storage) {
    ...
    var renderLineTournament = function renderLineTournament(tournament, parent) {
        ...
        if ((typeof tournament.rules_url == "undefined" || tournament.rules_url == null) && tournament.rules_url == 0 || (typeof tournament.rules_url == "undefined" || tournament.rules_url == null) && tournament.is_rules_pdf == 1) {
        ...
        if (typeof tournament.pictures !== "undefined" && tournament.pictures.length > 0) markup += activeURL(url_home + '/tournoi/' + tournament.slug + '/photos', url_image + '/tournament/tournament-pictures.png');else markup += inactiveURL(url_image + '/tournament/tournament-pictures.png');

        if (typeof tournament.videos !== "undefined" && tournament.videos.length > 0) markup += activeURL(url_home + '/tournoi/' + tournament.slug + '/videos', url_image + '/tournament/Tournament-videos.jpg');else markup += inactiveURL(url_image + '/tournament/Tournament-videos.jpg');
    ...
    var renderMemberTournament = function renderMemberTournament(member) {
        var markup = '<div class="event__noteam-line">';
    ...
    var activeURL = function activeURL(url, img) {
