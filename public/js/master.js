...
var alldropdown = document.querySelectorAll(".aside-left-bar__dropdown-btn");
var itemsdropdown = document.querySelectorAll(".aside-left-bar__dropdown");
...
alldropdown.forEach(function (item) {
    item.addEventListener('click', function (event) {
        ...
        itemsdropdown.forEach(function (e) {
            var elementToCheck = e.parentElement;
            if (!elementToCheck.isSameNode(event.target.parentElement)) e.classList.remove("aside-left-bar__dropdown-show");
        });
    });
});
