    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box box-warning">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form method="POST" action="/administration/annonces/{{ $ad->id }}"  enctype="multipart/form-data" role="form">
                        {{ csrf_field() }}
                        {{ method_field('PATCH') }}
                    ...
                    <div class="box-footer col-xs-6 pull-right">
                        <form method="POST" action="/administration/annonces/{{ $ad->id }}" role="form">
                            {{ csrf_field() }}
                            {{ method_field('DELETE') }}
