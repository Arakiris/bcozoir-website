    ...
    <div class="col-xs-12">
        ...
        <div class="box box-warning">
            <div class="box-header with-border">
                <h3 class="box-title">Cr&eacute;er une nouvelle information;</h3>
            </div>
            ...
            <div class="box-body">
                <form method="POST" action="/administration/actualites" role="form" id="form-Dropzone">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="body" class="form-control" rows="20" placeholder="Veuillez entrer le contenu de l'information"></textarea>
                    </div>
