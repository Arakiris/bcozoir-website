...
<section class="content">
    ...
    <div class="col-xs-12">
        ...
        <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form method="POST" action="/admin/membre/{{ $member->id }}/score/{{ $score->id }}" enctype="multipart/form-data" role="form">
                    {{ csrf_field() }}
                    {{ method_field('PATCH') }}
                ...
                <div class="box-footer col-xs-6 pull-right">
                    <form method="POST" action="/admin/membre/{{ $member->id }}/score/{{ $score->id }}" role="form">
                        {{ csrf_field() }}
                        {{ method_field('DELETE') }}
