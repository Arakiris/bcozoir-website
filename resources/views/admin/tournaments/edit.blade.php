            ...
            <div class="box-body">
                <form method="POST" action="/administration/tournois/{{ $tournament->id }}" enctype="multipart/form-data" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="ckeditor form-control" name="additional_information" rows="20" placeholder="Entrer vos informations complémentaires...">{{ $tournament->additional_information or '' }}</textarea>
                    </div>
