            ...
            <div id="tabs">
                <ul class="tabs">
                    ...
                    @foreach($tournamentsByYear as $year => $tournaments)
                        @if($first)
                            <?php $first = false; ?>
                            <li class="tab-link current"><a href="#tab-{{ $year }}">{{ $year }}</a></li>
                        @else
                        <li class="tab-link"><a href="{{ route('tabtournaments', ['1', $year]) }}">{{ $year }}</a></li>
                        @endif
                    @endforeach
                    @foreach ($years as $y)
                        <li class="tab-link"><a href="{{ route('tabtournaments', ['1', $y->year]) }}">{{ $y->year }}</a></li>
                    @endforeach
                </ul>
