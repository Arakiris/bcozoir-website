...
Route::get('/membres/{id}', 'MembersController@tournamentAndPrize')->name('membersPrize')->where('id', '[0-9]+');
...
Route::get('/classements-podiums', 'TournamentsController@rankingPodia')->name('classementPodiums');
Route::get('/archives/classements-podiums', 'TournamentsController@oldRankingPodia')->name('archivesClassementPodiums');

// // Route::get('administration/tournois/{id}/choix', 'TournamentsController@chooseTypePlayers')->name('admin.tournois.chooseType');
// // Route::get('administration/tournois/{id}/team', 'TournamentsController@editTeams')->name('admin.tournois.editTeams');
...
Route::get('/partenaires/devenir', 'PartnersController@becomePartner')->name('becomePartner');
...
Route::get('/documents-divers', 'DocumentsController@showall')->name('documentsDivers');
